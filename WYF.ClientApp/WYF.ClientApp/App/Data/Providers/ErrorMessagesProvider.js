(function () {
    ...
    function ErrorMessagesProvider() {
        ...
        var instance = {
            ...
            messageForNotMatchedUsername: "The Username must be between 2 and 15 characters and must contains only letters and digits",
            messageForNotMatchedEmail: "Enter valid email.",
            messageForNotMatchedName: "The name must be between 2 and 15 characters and must contains only letters.",

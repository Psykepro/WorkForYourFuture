namespace WYF.WebAPI.Models.Utilities
{
    public static class ErrorMessages
    {
        ...
        public const string NOT_MATCHED_CITY_NAME = "The City Name must be between 2 and 20 only letters and spaces.";
        ...
        public const string NOT_MATCHED_USERNAME = "The Username must be between 2 and 15 characters and must contains only letters, digits and underscore.";
        public const string NOT_MATCHED_EMAIL = "The passed email is invalid.";
        public const string NOT_MATCHED_NAME = "The name must be between 2 and 15 characters and must contains only letters and spaces.";
